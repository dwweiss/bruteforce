...
A preference of a particular trainer or activation of the hidden layers for minimizing the MSE variation of multiple trials has not been identified. Brute force scanning of the network parameter space is therefore recommended. The random initialization of weights should be repeated 3-5 times for each network configuration. 
